            ...
            boxShadow: [
              ...
              (
                ...
                child: Row(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: <Widget>[ 
                  Image.asset("../assets/images/lines.png",height: 15,width: 15),
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children:  [
                  const Text('Địa chỉ hiện tại', style: TextStyle( fontSize: 15 ),),
                  Text('101 Hung Vuong, TpHcm', style: TextStyle( fontSize: 13 , color: ColorConstants.textColor1),)
                              ],
                  ),
                )
              ],
